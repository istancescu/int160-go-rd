...
func Test_newInt160FromHexSha(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			res, _ := NewInt160FromHex(tt.input)
			assert.Equal(t, tt.want.Bytes(), res.Bytes())
		})
	}
}
...
func TestXor(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			assert.Equal(t, tt.want.Bytes(), tt.args.a.Xor(tt.args.b).Bytes())
		})
	}
}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if !tt.wantErr {
				...
				if !bytes.Equal(gotBytes[:], tt.input) {
...
func Test_int160_Equals(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			if got := i.Equals(tt.args.other); got != tt.want {
...
func TestClone(t *testing.T) {
	...
	if !reflect.DeepEqual(original.val, cloned.Bytes()) {
		t.Errorf("Clone() returned incorrect values: got %v, want %v", cloned.Bytes(), original.val)
	}

	original.val[0] = 255
	if original.val[0] == cloned.Bytes()[0] {
